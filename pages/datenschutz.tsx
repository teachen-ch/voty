  ...
  return (
    <Page heading="Datenschutz">
      ...
      <Text>
        ...
        abstimmen, dann speichern wir auf unseren Servern, an welcher Abstimmung
        Sie teilgenommen haben. Die eigentliche Stimme wird nicht mit ihrem
        Konto verknüpft, da wir die politischen Meinung anonym behalten wollen.
        Um statistische Auswertungen relevanter zu machen, werden jedoch
        folgende Attribute zu ihrer Stimme gespeichert, sofern Sie diese in
        ihrem Profil gespeichert haben: Alter, Geschlecht, Schulhaus, Klasse.
      </Text>
      ...
      <Text>
        Wenn Sie auf unserer Website ohne Konto abstimmen, speichert ihr Browser
        ein anonymes Cookie. Aus diesem Cookie können wir keine Rückschlüsse auf
        ihre Person ziehen und wir speichern dieses auch nicht unseren Servern.
        Wenn Sie sich auf unserer Website anmelden, verwenden wir die
        LocalStorage ihres Browsers, um ihren Anmeldestatus zu speichern. Bei
        jedem Besuch unserer Plattform werden sie deshalb automatisch
        eingeloggt. Sobald sie sich auf unserer Plattform abmelden, wird die
      ...
      <Text>
        ...
        Videos, Bilder, Beiträge etc.). Eingebettete Inhalte von anderen
      ...
      <Text>
        ...
        Interaktion mit diesem eingebetteten Inhalt aufzeichnen, inklusive ihrer
        Interaktion mit dem eingebetteten Inhalt, falls Sie ein Konto haben und
      ...
      <Text>
        Wenn Sie ein Konto auf dieser Website besitzen, können Sie einen Export
        ihrer personenbezogenen Daten bei uns anfordern, inklusive aller Daten,
        die Sie uns mitgeteilt haben. Darüber hinaus können Sie die Löschung
        aller personenbezogenen Daten, die wir von Ihnen gespeichert haben,
