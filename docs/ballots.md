...
- Create a new voty-ballots-2026-qX.yaml from voty-ballots-easyvote-template.yaml
- Add texts and links from easyvote.ch
- Run `python ansible/scripts/ballots_to_sql.py backup/voty-ballots-2026-q3.yml
- run `ssh -t app@prod "./psql"` and copy & paste the sql statements from above file
- run `ssh -t app@dev "./psql"` if needed
