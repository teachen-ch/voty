...
export function InfiniteCanvas({ roomId, participantId, isTeacher, stickyEnabled }: Props) {
  ...
  useLayoutEffect(() => {
    ...
    canvasTransform.value = { x: width / 2 - INIT_X, y: height / 2 - INIT_Y, scale: 1 }
  ...
  function onPointerDown(e: PointerEvent) {
    ...
    panRef.current = {
      ...
      tx: canvasTransform.value.x, ty: canvasTransform.value.y,
    }
  ...
  async function onClick(e: MouseEvent) {
    ...
    await pb.collection('sticky_notes').create({
      room: roomId, content: '', pos_x: wx, pos_y: wy,
    ...
    >
      <div
        style={{
          ...
          backgroundImage: 'radial-gradient(circle, #c5cbd3 1.5px, transparent 1.5px)',
