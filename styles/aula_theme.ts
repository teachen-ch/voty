...
const theme = deepclone(votyTheme) as any;

//                [12, 16, 20, 22, 26, 34, 50, 50, 50];
...
theme.text.heading.color = theme.colors.primary;
theme.styles.root.h2.color = theme.colors.primary;
theme.fontWeights = {
  body: 400,
  semi: 600,
  heading: 300,
...
/*{
  ...
  label: { textAlign: "left", fontSize: [2, 2, 3] },
  textarea: {
    bg: "textarea",
    color: "gray",
    border: "none",
